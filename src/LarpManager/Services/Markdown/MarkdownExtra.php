...
namespace LarpManager\Services\Markdown;

final class MarkdownExtra extends Markdown
{
    /**
    ...
    protected function setup()
    {
        ...
        foreach ($this->predef_abbr as $abbr_word => $abbr_desc) {
            if ($this->abbr_word_re)
                $this->abbr_word_re .= '|';
            $this->abbr_word_re .= preg_quote($abbr_word, null);
     ...
     * @return string
     */
    protected function doExtraAttributes($tag_name, $attr, $defaultIdValue = null, $classes = array()): string
    {
     ...
     * @return string
     */
    protected function stripLinkDefinitions($text): string
    {
     ...
     * @return string
     */
    protected function _stripLinkDefinitions_callback($matches): string
    {
     ...
     * @return string
     */
    protected function hashHTMLBlocks($text): string
    {
        if ($this->no_markup) {
            return $text;
        }
    ...
    protected function _hashHTMLBlocks_inMarkdown($text, $indent = 0,
                                                  $enclosing_tag_re = '', $span = false): array
    {
     ...
     * @return string
     */
    protected function hashClean($text): string
    {
     ...
     * @return string
     */
    protected function doAnchors($text): string
    {
        if ($this->in_anchor) {
            return $text;
        }
     ...
     * @return string
     */
    protected function _doAnchors_reference_callback($matches): string
    {
     ...
     * @return string
     */
    protected function _doAnchors_inline_callback($matches): string
    {
     ...
     * @return string
     */
    protected function doImages($text): string
    {
     ...
     * @return string
     */
    protected function _doImages_reference_callback($matches): string
    {
        $whole_match = $matches[1];
        $alt_text = $matches[2];
     ...
     * @return string
     */
    protected function _doImages_inline_callback($matches): string
    {
        $alt_text = $matches[2];
        $url = $matches[3] === '' ? $matches[4] : $matches[3];
        $title_quote =& $matches[6];
     ...
     * @return string
     */
    protected function doHeaders($text): string
    {
     ...
     * @return string
     */
    protected function _doHeaders_callback_setext($matches): string
    {
     ...
     * @return string
     */
    protected function _doHeaders_callback_atx($matches): string
    {
     ...
     * @return string
     */
    protected function doTables($text): string
    {
        $less_than_tab = $this->tab_width - 1;
     ...
     * @return string
     */
    protected function _doTable_leadingPipe_callback($matches): string
    {
        $head = $matches[1];
        $underline = $matches[2];
        $content = $matches[3];
     ...
     * @return string
     */
    protected function _doTable_makeAlignAttr(string $alignname): string
    {
     ...
     * @return string
     */
    protected function _doTable_callback($matches): string
    {
        $head = $matches[1];
        $underline = $matches[2];
        $content = $matches[3];
     ...
     * @return string
     */
    protected function doDefLists($text): string
    {
        $less_than_tab = $this->tab_width - 1;
     ...
     * @return string
     */
    protected function _doDefLists_callback($matches): string
    {
     ...
     * @return string
     */
    protected function processDefListItems($list_str): string
    {
     ...
     * @return string
     */
    protected function _processDefListItems_callback_dt($matches): string
    {
        $terms = explode("\n", trim($matches[1]));
        $text = '';
     ...
     * @return string
     */
    protected function _processDefListItems_callback_dd($matches): string
    {
     ...
     * @return string
     */
    protected function doFencedCodeBlocks($text): string
    {
     ...
     * @return string
     */
    protected function _doFencedCodeBlocks_callback($matches): string
    {
        $classname =& $matches[2];
        $attrs =& $matches[3];
        $codeblock = $matches[4];
     ...
     * @return string
     */
    protected function _doFencedCodeBlocks_newlines($matches): string
    {
     ...
     */
    protected function formParagraphs($text, $wrap_in_p = true): string
    {
     ...
     * @return string
     */
    protected function stripFootnotes($text): string
    {
        $less_than_tab = $this->tab_width - 1;
     ...
     * @return string
     */
    protected function _stripFootnotes_callback($matches): string
    {
     ...
     * @return string
     */
    protected function doFootnotes($text): string
    {
        if (!$this->in_anchor) {
     ...
     * @return string
     */
    protected function appendFootnotes($text): string
    {
     ...
     * @return string
     */
    protected function parseFootnotePlaceholders($label, $footnote_number, $reference_number): string
    {
        return str_replace(
            array('^^', '%%'),
     ...
     * @return string
     */
    protected function stripAbbreviations($text): string
    {
        $less_than_tab = $this->tab_width - 1;
     ...
     * @return string
     */
    protected function _stripAbbreviations_callback(array $matches): string
    {
        $abbr_word = $matches[1];
        $abbr_desc = $matches[2];
        if ($this->abbr_word_re) {
     ...
     * @return string
     */
    protected function doAbbreviations($text): string
    {
        if ($this->abbr_word_re) {
     ...
     * @return string
     */
    protected function _doAbbreviations_callback($matches): string
    {
        $abbr = $matches[0];
