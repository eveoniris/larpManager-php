...
class BasePersonnage
{
    ...
    /**
     * @OneToMany(targetEntity="Joueur", mappedBy="personnage")
    ...
    /**
     * Add Joueur entity to collection (one to many).
     *
    ...
    /**
     * Remove Joueur entity from collection (one to many).
     *
     * @param \LarpManager\Entities\Joueur $joueur
     * @return \LarpManager\Entities\Personnage
     */
    ...
    /**
     * Get Joueur entity collection (one to many).
     *
