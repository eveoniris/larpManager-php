 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-09-13 08:57:56.
 ...
 *
 * @Entity()
 * @Table(name="personnage", indexes={@Index(name="fk_personnage_groupe1_idx", columns={"groupe_id"}), @Index(name="fk_personnage_archetype1_idx", columns={"classe_id"}), @Index(name="fk_personnage_age1_idx", columns={"age_id"}), @Index(name="fk_personnage_genre1_idx", columns={"genre_id"}), @Index(name="fk_personnage_territoire1_idx", columns={"territoire_id"})})
...
class BasePersonnage
{
    ...
    /**
     * @OneToMany(targetEntity="User", mappedBy="personnageRelatedByPersonnageId")
     * @JoinColumn(name="id", referencedColumnName="personnage_id", nullable=false)
     */
    protected $userRelatedByPersonnageIds;
    ...
    public function __construct()
    {
        ...
        $this->userRelatedByPersonnageIds = new ArrayCollection();
    ...
    /**
     * Add User entity related by `personnage_id` to collection (one to many).
     *
     * @param \LarpManager\Entities\User $user
     * @return \LarpManager\Entities\Personnage
     */
    public function addUserRelatedByPersonnageId(User $user)
    {
        $this->userRelatedByPersonnageIds[] = $user;

        return $this;
    }

    /**
     * Remove User entity related by `personnage_id` from collection (one to many).
     *
     * @param \LarpManager\Entities\User $user
     * @return \LarpManager\Entities\Personnage
     */
    public function removeUserRelatedByPersonnageId(User $user)
    {
        $this->userRelatedByPersonnageIds->removeElement($user);

        return $this;
    }

    /**
     * Get User entity related by `personnage_id` collection (one to many).
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getUserRelatedByPersonnageIds()
    {
        return $this->userRelatedByPersonnageIds;
    }
    ...
    {
        return array('id', 'nom', 'surnom', 'intrigue', 'groupe_id', 'classe_id', 'age_id', 'genre_id', 'renomme', 'photo', 'xp', 'territoire_id', 'materiel', 'vivant', 'age_reel', 'trombineUrl');
    }
}