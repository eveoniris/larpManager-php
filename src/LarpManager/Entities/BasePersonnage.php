 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2017-04-17 10:24:50.
...
class BasePersonnage
{
    ...
    {
        return array('id', 'nom', 'surnom', 'intrigue', 'groupe_id', 'classe_id', 'age_id', 'genre_id', 'renomme', 'photo', 'xp', 'territoire_id', 'materiel', 'vivant', 'age_reel', 'trombineUrl', 'user_id', 'richesse');
    }
}