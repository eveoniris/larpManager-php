...
class BasePersonnage
{
    ...
    /**
     * @OneToOne(targetEntity="Joueur", inversedBy="personnage")
    ...
    {
        return array('id', 'nom', 'surnom', 'intrigue', 'groupe_id', 'classe_id', 'age_id', 'genre_id', 'renomme', 'photo', 'background_id', 'personnage_religion_id', 'joueur_id');
    }
}