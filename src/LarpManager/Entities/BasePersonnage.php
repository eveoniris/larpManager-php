...
class BasePersonnage
{
    ...
    /**
     * @OneToMany(targetEntity="ExperienceGain", mappedBy="personnage", cascade={"remove"})
     * @JoinColumn(name="id", referencedColumnName="personnage_id", nullable=false)
     */
    protected $experienceGains;

    /**
     * @OneToMany(targetEntity="ExperienceUsage", mappedBy="personnage", cascade={"remove"})
     * @JoinColumn(name="id", referencedColumnName="personnage_id", nullable=false)
     */
    protected $experienceUsages;

    /**
     * @OneToMany(targetEntity="Postulant", mappedBy="personnage", cascade={"remove"})
     * @JoinColumn(name="id", referencedColumnName="personnage_id", nullable=false)
     */
     ...
     *     inverseJoinColumns={@JoinColumn(name="secondary_group_id", referencedColumnName="id", nullable=false)}
     * )
     */
    ...
    {
        return array('id', 'nom', 'surnom', 'intrigue', 'groupe_id', 'classe_id', 'age_id', 'genre_id', 'renomme', 'photo', 'personnage_religion_id', 'joueur_id', 'xp', 'territoire_id');
    }
}