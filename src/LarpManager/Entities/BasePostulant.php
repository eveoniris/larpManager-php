...
class BasePostulant
{
     ...
     * @JoinColumn(name="secondary_group_id", referencedColumnName="id")
     */
    protected $secondaryGroup;

    /**
     * @ManyToOne(targetEntity="Personnage", inversedBy="postulants", cascade={"remove"})
    ...
    {
        return array('id', 'date', 'secondary_group_id', 'personnage_id', 'explanation');
    }
}