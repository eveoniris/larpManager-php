 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-09-13 11:12:04.
...
class BaseUser
{
    ...
    /**
     * @OneToMany(targetEntity="Personnage", mappedBy="userRelatedByUserId")
     * @JoinColumn(name="id", referencedColumnName="user_id", nullable=false)
     */
    protected $personnageRelatedByUserIds;
    ...
    /**
     * @ManyToOne(targetEntity="Personnage", inversedBy="userRelatedByPersonnageIds")
    ...
    public function __construct()
    {
        ...
        $this->personnageRelatedByUserIds = new ArrayCollection();
    ...
    /**
     * Add Personnage entity related by `user_id` to collection (one to many).
     *
     * @param \LarpManager\Entities\Personnage $personnage
     * @return \LarpManager\Entities\User
     */
    public function addPersonnageRelatedByUserId(Personnage $personnage)
    {
        $this->personnageRelatedByUserIds[] = $personnage;

        return $this;
    }

    /**
     * Remove Personnage entity related by `user_id` from collection (one to many).
     *
     * @param \LarpManager\Entities\Personnage $personnage
     * @return \LarpManager\Entities\User
     */
    public function removePersonnageRelatedByUserId(Personnage $personnage)
    {
        $this->personnageRelatedByUserIds->removeElement($personnage);

        return $this;
    }

    /**
     * Get Personnage entity related by `user_id` collection (one to many).
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getPersonnageRelatedByUserIds()
    {
        return $this->personnageRelatedByUserIds;
    }
