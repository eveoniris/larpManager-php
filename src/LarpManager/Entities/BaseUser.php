...
class BaseUser
{
    ...
    /**
     * @OneToMany(targetEntity="Joueur", mappedBy="user")
     ...
     * @JoinColumn(name="etat_civil_id", referencedColumnName="id", nullable=true)
     */
    protected $etatCivil;
    ...
    {
        return array('id', 'email', 'password', 'salt', 'rights', 'name', 'creation_date', 'username', 'isEnabled', 'confirmationToken', 'timePasswordResetRequested', 'etat_civil_id');
    }
}