 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-08-22 10:01:24.
...
class BaseUser
{
    ...
    /**
     * @OneToMany(targetEntity="Billet", mappedBy="userRelatedByCreateurId")
     * @JoinColumn(name="id", referencedColumnName="createur_id", nullable=false)
     */
    protected $billetRelatedByCreateurIds;
    ...
    /**
     * @ManyToMany(targetEntity="Billet", inversedBy="users")
     * @JoinTable(name="user_has_billet",
     *     joinColumns={@JoinColumn(name="user_id", referencedColumnName="id", nullable=false)},
     *     inverseJoinColumns={@JoinColumn(name="billet_id", referencedColumnName="id", nullable=false)}
     * )
     */
    protected $billets;
    ...
    /**
     * @ManyToMany(targetEntity="Restauration", inversedBy="users")
     * @JoinTable(name="user_has_restauration",
     *     joinColumns={@JoinColumn(name="user_id", referencedColumnName="id", nullable=false)},
     *     inverseJoinColumns={@JoinColumn(name="restauration_id", referencedColumnName="id", nullable=false)}
     * )
     */
    protected $restaurations;
    ...
    public function __construct()
    {
        ...
        $this->billetRelatedByCreateurIds = new ArrayCollection();
    ...
    /**
     * Add Billet entity related by `createur_id` to collection (one to many).
     *
     * @param \LarpManager\Entities\Billet $billet
     * @return \LarpManager\Entities\User
     */
    public function addBilletRelatedByCreateurId(Billet $billet)
    {
        $this->billetRelatedByCreateurIds[] = $billet;

        return $this;
    }

    /**
     * Remove Billet entity related by `createur_id` from collection (one to many).
     *
     * @param \LarpManager\Entities\Billet $billet
     * @return \LarpManager\Entities\User
     */
    public function removeBilletRelatedByCreateurId(Billet $billet)
    {
        $this->billetRelatedByCreateurIds->removeElement($billet);

        return $this;
    }

    /**
     * Get Billet entity related by `createur_id` collection (one to many).
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getBilletRelatedByCreateurIds()
    {
        return $this->billetRelatedByCreateurIds;
    }
    ...
    /**
     * Add Billet entity to collection.
     *
     * @param \LarpManager\Entities\Billet $billet
     * @return \LarpManager\Entities\User
     */
    ...
    /**
     * Remove Billet entity from collection.
     *
     * @param \LarpManager\Entities\Billet $billet
     * @return \LarpManager\Entities\User
     */
    ...
    /**
     * Add Restauration entity to collection.
     *
     * @param \LarpManager\Entities\Restauration $restauration
     * @return \LarpManager\Entities\User
     */
    public function addRestauration(Restauration $restauration)
    {
        $restauration->addUser($this);
    ...
    /**
     * Remove Restauration entity from collection.
     *
     * @param \LarpManager\Entities\Restauration $restauration
     * @return \LarpManager\Entities\User
     */
    public function removeRestauration(Restauration $restauration)
    {
        $restauration->removeUser($this);
    ...
    /**
     * Get Restauration entity collection.
     *
     * @return \Doctrine\Common\Collections\Collection
     */
