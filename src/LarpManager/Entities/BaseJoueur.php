...
class BaseJoueur
{
    ...
    {
        return array('id', 'personnage_id', 'nom', 'prenom', 'prenom_usage', 'telephone', 'photo', 'probleme_medicaux', 'personne_a_prevenir', 'tel_pap', 'fedegn', 'creation_date', 'update_date', 'date_fin_validite_fedegn');
    }
}