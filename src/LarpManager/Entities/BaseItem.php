 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-09-30 09:56:53.
 ...
 *
 * @Entity()
 * @Table(name="item", indexes={@Index(name="fk_item_qualite1_idx", columns={"quality_id"}), @Index(name="fk_item_statut1_idx", columns={"statut_id"})})
...
class BaseItem
{
    ...
    {
        return array('id', 'label', 'description', 'numero', 'identification', 'quality_id', 'special', 'couleur', 'date_creation', 'date_update', 'statut_id');
    }
}