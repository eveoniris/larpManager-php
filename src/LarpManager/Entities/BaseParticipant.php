 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-08-26 08:29:20.
...
class BaseParticipant
{
    ...
    /**
     * @OneToMany(targetEntity="ParticipantHasRestauration", mappedBy="participant")
    ...
    {
        return array('id', 'gn_id', 'subscription_date', 'user_id', 'groupe_id', 'personnage_secondaire_id', 'personnage_id', 'billet_id');
    }
}