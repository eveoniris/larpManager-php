 ...
 *
 * @Entity()
 * @Table(name="participant", indexes={@Index(name="fk_joueur_gn_gn1_idx", columns={"gn_id"}), @Index(name="fk_joueur_gn_user1_idx", columns={"user_id"}), @Index(name="fk_participant_groupe1_idx", columns={"groupe_id"})})
...
class BaseParticipant
{
    ...
    {
        return array('id', 'gn_id', 'subscription_date', 'user_id', 'groupe_id');
    }
}