 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-07-24 16:33:11.
...
class BaseParticipant
{
    ...
    /**
     * Set the value of tavern_id.
     *
     * @param integer $tavern_id
     * @return \LarpManager\Entities\Participant
     */
    public function setTavernId($tavern_id)
    {
    ...
    /**
     * Get the value of tavern_id.
     *
     * @return integer
     */
    public function getTavernId()
    {
    ...
    {
        return array('id', 'gn_id', 'subscription_date', 'user_id', 'groupe_id', 'personnage_secondaire_id', 'tavern_id');
    }
}