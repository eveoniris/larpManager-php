...
class BaseRegion
{
    ...
    /**
     * @ManyToMany(targetEntity="Ressource", inversedBy="regions", cascade={"persist"})
     * @JoinTable(name="region_ressource",
