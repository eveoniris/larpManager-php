 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-03-13 18:01:08.
 ...
 *
 * @Entity()
 * @Table(name="groupe", indexes={@Index(name="fk_groupe_users1_idx", columns={"scenariste_id"}), @Index(name="fk_groupe_user2_idx", columns={"responsable_id"}), @Index(name="fk_groupe_espace1_idx", columns={"territoire_id"}), @Index(name="fk_groupe_topic1_idx", columns={"topic_id"})})
...
class BaseGroupe
{
     ...
     * @JoinColumn(name="id", referencedColumnName="groupe_allie_id")
     */
     ...
     * @JoinColumn(name="id", referencedColumnName="groupe_enemy_id")
     */
    ...
    {
        return array('id', 'nom', 'description', 'numero', 'code', 'jeu_maritime', 'jeu_strategique', 'scenariste_id', 'classe_open', 'responsable_id', 'territoire_id', 'topic_id', 'pj');
    }
}