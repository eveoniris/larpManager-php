 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2015-09-01 20:29:49.
...
class BaseGroupe
{
    ...
    /**
     * @OneToMany(targetEntity="GroupeGn", mappedBy="groupe", cascade={"persist"})
     * @JoinColumn(name="id", referencedColumnName="groupe_id")
     */
    protected $groupeGns;
    ...
    /**
     * @ManyToMany(targetEntity="Joueur", mappedBy="groupes")
     */
    protected $joueurs;
    ...
    {
        return array('id', 'nom', 'description', 'numero', 'code', 'jeu_maritime', 'jeu_strategique', 'scenariste_id', 'classe_open', 'responsable_id', 'territoire_id', 'topic_id');
    }
}