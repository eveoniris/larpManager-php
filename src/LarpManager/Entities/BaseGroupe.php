 ...
 *
 * @Entity()
 * @Table(name="groupe", indexes={@Index(name="fk_groupe_users1_idx", columns={"scenariste_id"}), @Index(name="fk_groupe_user2_idx", columns={"responsable_id"}), @Index(name="fk_groupe_espace1_idx", columns={"territoire_id"}), @Index(name="fk_groupe_topic1_idx", columns={"topic_id"}), @Index(name="fk_groupe_background1_idx", columns={"background_id"})})
...
class BaseGroupe
{
    ...
    /**
     * @ManyToOne(targetEntity="Background", inversedBy="groupes")
    ...
    {
        return array('id', 'nom', 'description', 'numero', 'code', 'jeu_maritime', 'jeu_strategique', 'scenariste_id', 'classe_open', 'responsable_id', 'territoire_id', 'topic_id', 'background_id');
    }
}