 ...
 *
 * @Entity()
 * @Table(name="groupe", indexes={@Index(name="fk_groupe_users1_idx", columns={"scenariste_id"}), @Index(name="fk_groupe_region1_idx", columns={"region_id"}), @Index(name="fk_groupe_user1_idx", columns={"creator_id"}), @Index(name="fk_groupe_user2_idx", columns={"responsable_id"})})
...
class BaseGroupe
{
    ...
    /**
     * @OneToMany(targetEntity="Personnage", mappedBy="groupeRelatedByGroupeId")
     * @JoinColumn(name="id", referencedColumnName="groupe_id")
     */
    protected $personnageRelatedByGroupeIds;
    ...
    /**
     * @ManyToOne(targetEntity="Region", inversedBy="groupes")
    ...
    /**
     * @ManyToMany(targetEntity="Personnage", mappedBy="groupes")
     */
    ...
    public function __construct()
    {
        ...
        $this->personnageRelatedByGroupeIds = new ArrayCollection();
    ...
    /**
     * Add Personnage entity related by `groupe_id` to collection (one to many).
     *
     * @param \LarpManager\Entities\Personnage $personnage
     * @return \LarpManager\Entities\Groupe
     */
    public function addPersonnageRelatedByGroupeId(Personnage $personnage)
    {
        $this->personnageRelatedByGroupeIds[] = $personnage;

        return $this;
    }

    /**
     * Remove Personnage entity related by `groupe_id` from collection (one to many).
     *
     * @param \LarpManager\Entities\Personnage $personnage
     * @return \LarpManager\Entities\Groupe
     */
    public function removePersonnageRelatedByGroupeId(Personnage $personnage)
    {
        $this->personnageRelatedByGroupeIds->removeElement($personnage);

        return $this;
    }

    /**
     * Get Personnage entity related by `groupe_id` collection (one to many).
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getPersonnageRelatedByGroupeIds()
    {
        return $this->personnageRelatedByGroupeIds;
    }
    ...
    {
        return array('id', 'nom', 'description', 'numero', 'code', 'jeu_maritime', 'jeu_strategique', 'scenariste_id', 'region_id', 'creation_date', 'update_date', 'creator_id', 'classe_open', 'responsable_id');
    }
}