 ...
 *
 * @Entity()
 * @Table(name="groupe", indexes={@Index(name="fk_groupe_users1_idx", columns={"scenariste_id"}), @Index(name="fk_groupe_region1_idx", columns={"region_id"}), @Index(name="fk_groupe_user1_idx", columns={"creator_id"})})
...
class BaseGroupe
{
    ...
    {
        return array('id', 'nom', 'description', 'numero', 'code', 'jeu_maritime', 'jeu_strategique', 'scenariste_id', 'region_id', 'creation_date', 'update_date', 'creator_id', 'classe_open');
    }
}