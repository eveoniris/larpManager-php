 ...
 *
 * @Entity()
 * @Table(name="groupe", indexes={@Index(name="fk_groupe_users1_idx", columns={"scenariste_id"}), @Index(name="fk_groupe_user2_idx", columns={"responsable_id"}), @Index(name="fk_groupe_espace1_idx", columns={"territoire_id"})})
...
class BaseGroupe
{
    ...
    {
        return array('id', 'nom', 'description', 'numero', 'code', 'jeu_maritime', 'jeu_strategique', 'scenariste_id', 'classe_open', 'responsable_id', 'territoire_id');
    }
}