...
class BaseGroupe
{
    ...
    /**
     * @OneToMany(targetEntity="Fief", mappedBy="groupe")
    ...
    /**
     * Add Fief entity to collection (one to many).
     *
    ...
    /**
     * Remove Fief entity from collection (one to many).
     *
     * @param \LarpManager\Entities\Fief $fief
     * @return \LarpManager\Entities\Groupe
     */
    ...
    /**
     * Get Fief entity collection (one to many).
     *
