 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-09-07 17:41:30.
...
class BaseGroupe
{
    ...
    {
        return array('id', 'nom', 'description', 'numero', 'code', 'jeu_maritime', 'jeu_strategique', 'scenariste_id', 'classe_open', 'responsable_id', 'topic_id', 'pj', 'materiel', 'lock', 'territoire_id', 'placeAvailable');
    }
}