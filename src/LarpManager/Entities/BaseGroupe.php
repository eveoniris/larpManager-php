...
class BaseGroupe
{
    ...
    /**
     * @ManyToMany(targetEntity="User", inversedBy="groupes")
     * @JoinTable(name="user_has_groupe",
     *     joinColumns={@JoinColumn(name="groupe_id", referencedColumnName="id", nullable=false)},
    ...
    {
        return array('id', 'nom', 'description', 'numero', 'code', 'jeu_maritime', 'jeu_strategique', 'scenariste_id', 'classe_open', 'responsable_id', 'topic_id', 'pj', 'materiel', 'lock', 'territoire_id', 'free', 'placeAvailable');
    }
}