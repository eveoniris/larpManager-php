 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2017-07-01 12:27:44.
...
class BaseSecondaryGroup
{
    ...
    {
        return array('id', 'label', 'description', 'secondary_group_type_id', 'personnage_id', 'topic_id', 'description_secrete', 'secret');
    }
}