...
class BaseGn
{
    ...
    /**
     * @OneToMany(targetEntity="Joueur", mappedBy="gn", cascade={"persist"})
     * @JoinColumn(name="id", referencedColumnName="gn_id")
     */
    protected $joueurs;

    /**
     * @ManyToOne(targetEntity="Topic", inversedBy="gns")
     ...
     *     joinColumns={@JoinColumn(name="gn_id", referencedColumnName="id")},
