...
class BaseGn
{
     ...
     * @Column(type="text", nullable=true)
     */
    protected $conditions_generales;
    ...
    /**
     * Set the value of conditions_generales.
     *
     * @param string $conditions_generales
     * @return \LarpManager\Entities\Gn
     */
    public function setConditionsGenerales($conditions_generales)
    {
    ...
    /**
     * Get the value of conditions_generales.
     *
     * @return string
     */
    ...
    {
        return array('id', 'label', 'xp_creation', 'description', 'date_debut', 'date_fin', 'date_installation_joueur', 'date_fin_orga', 'adresse', 'topic_id', 'actif', 'billetterie', 'conditions_generales');
    }
}