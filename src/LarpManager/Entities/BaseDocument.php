 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2016-08-05 12:20:46.
...
class BaseDocument
{
    ...
    /**
     * @ManyToMany(targetEntity="Groupe", inversedBy="documents")
    ...
    /**
     * @ManyToMany(targetEntity="Lieu", inversedBy="documents")
     * @JoinTable(name="lieu_has_document",
     *     joinColumns={@JoinColumn(name="document_id", referencedColumnName="id", nullable=false)},
     *     inverseJoinColumns={@JoinColumn(name="lieu_id", referencedColumnName="id", nullable=false)}
     * )
     */
    protected $lieus;
    ...
    {
        return array('id', 'code', 'titre', 'description', 'documentUrl', 'cryptage', 'statut', 'auteur', 'user_id', 'creation_date', 'update_date');
    }
}