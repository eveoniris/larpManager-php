 ...
 *
 * @Entity()
 * @Table(name="annonce", indexes={@Index(name="fk_annonce_gn1_idx", columns={"gn_id"})})
...
class BaseAnnonce
{
    ...
    /**
     * @ManyToOne(targetEntity="Gn", inversedBy="annonces")
    ...
    {
        return array('id', 'title', 'text', 'creation_date', 'update_date', 'archive', 'gn_id');
    }
}