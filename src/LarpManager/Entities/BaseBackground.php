 ...
 * Version 2.1.6-dev (doctrine2-annotation) on 2015-10-14 15:00:49.
...
class BaseBackground
{
    ...
    /**
     * @OneToMany(targetEntity="Groupe", mappedBy="background")
     * @JoinColumn(name="id", referencedColumnName="background_id", nullable=false)
     */
    protected $groupes;
